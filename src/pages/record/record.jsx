...
import RecordList3 from './components/recordList3';
import './record.css';
      ...
      <main className="common-con-top">
        ...
        <section className="record-nav-con">
          <nav className="record-nav">
            <NavLink to={`${this.props.match.path}/passed`} className="nav-link">通过</NavLink>
        ...
        <Switch>
          <Route path={`${this.props.match.path}/passed`} component={RecordList} />
          <Route path={`${this.props.match.path}/audited`} component={RecordList2} />
          <Route path={`${this.props.match.path}/failed`} component={RecordList3} />
